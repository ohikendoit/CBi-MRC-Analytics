...
#Load Dataframe
df_extracted = pd.read_csv('df_extracted_4.csv', engine='python', encoding='utf-8', error_bad_lines=False)
df_extracted['clean_text'] = df_extracted['clean_text'].map(str)
...
for i in range(len(df_extracted['clean_text'])):
    ...
    text = df_extracted['clean_text'][i]
...
df_documentConcepts.to_csv('df_documentConcepts_4.csv')
